...
ent-CMMREFoodChocolateBrownie = chocolate brownie
    .desc = The contents of a Marine Standard issue MRE. This one is chocolate brownie.
ent-CMMREFoodSugarCookie = sugar cookie
    .desc = The contents of a Marine Standard issue MRE. This one is sugar cookie.
ent-CMMREFoodCocoBar = coco bar
    .desc = The contents of a Marine Standard issue MRE. This one is coco bar.
