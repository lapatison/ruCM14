...
cm-xeno-requires-more-plasma = { $construction } требует ещё { $plasma } плазмы.
# todo разбивка по кол-ву
cm-xeno-construction-plasma-left = Тут намечена постройка { $construction }. Необходимо ещё [color=cyan]{ $plasma }[/color] плазмы.
# todo разбивка по кол-ву
...
# todo разбивка по кол-ву
cm-xeno-plasma-transferred-to-self = Вы получили { $plasma } плазмы от { $target }. Теперь у вас { $total }
# todo разбивка по кол-ву
