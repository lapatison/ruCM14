...
ent-CMAttachmentS42xTelescopicMiniScope = S4 2x telescopic mini-scope
    .desc = An AEGIS S4 telescoping eye piece. Fixed at a modest 2x zoom. Press the 'use rail attachment' HUD icon or use the verb of the same name to zoom.
...
ent-CMAttachments84xTelescopicScope = S8 4x telescopic scope
    .desc = An AEGIS S8 telescopic eye piece. Fixed at 4x zoom. Press the 'use rail attachment' HUD icon or use the verb of the same name to zoom.
