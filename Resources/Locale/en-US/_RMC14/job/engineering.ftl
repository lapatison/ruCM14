...
cm-job-description-ordnance-tech = Создавайте нестандартные боеприпасы для пехотинцев. Поддерживайте в рабочем состоянии орбитальные орудия и десантные корабли.
CMJobOrdnanceTech = Техник по вооружению

cm-job-name-maint-tech = Техник по обслуживанию
cm-job-description-maint-tech = Поддерживайте термоядерные реакторы S-52 в рабочем состоянии. Обслуживайте и модифицируйте "Ольмейер" и его десантные корабли.
